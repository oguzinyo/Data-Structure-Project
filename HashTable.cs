...
namespace Proje4
{
    ...
    /// <summary>
    /// Graf içindeki düğümü (cüzdan adresini) temsil eder.
    /// HashTable'da anahtar olarak kullanılır.
    /// </summary>
    ...
    /// <summary>
    /// İşlem verilerini temsil eder.
    /// HashTable'da değer olarak saklanır.
    /// </summary>
    public class Transaction
    {
        ...
        public Transaction(string txId, string from, string to, decimal amount, DateTime timestamp)
        {
            TransactionId = txId;
            FromAddress = from;
            ToAddress = to;
        ...
        public override string ToString() => $"Tx[{TransactionId}]: {FromAddress} -> {ToAddress} : {Amount}";
    }
